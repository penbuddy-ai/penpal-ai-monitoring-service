...
describe("Monitoring MetricsService", () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        MetricsService,
        { provide: HttpService, useValue: { get: jest.fn().mockReturnValue(of({ data: {} })) } },
        ...
        { provide: HealthService, useValue: { checkAllServices: jest.fn().mockResolvedValue([]), getHealthSummary: jest.fn().mockResolvedValue({ status: "ok" }) } },
